    ...
    <div className="max-w-md mx-auto h-fit mt-10 p-6 bg-white rounded-xl shadow-md space-y-6">
      ...
      {selectedMethod === 'netbanking' && (
        <div className="bg-blue-50 p-4 rounded-md space-y-1 text-sm text-gray-700">
          <p><span className="font-bold">Bank:</span> SBI</p>
          <p><span className="font-bold">Account No.:</span> 1234567890</p>
          <p><span className="font-bold">IFSC:</span> SBIN0000123</p>
          <p><span className="font-bold">Account Holder:</span> NCW Fireworks</p>
        </div>
      )}
